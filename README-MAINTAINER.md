...
- name the file like `2020-12-19-architecture-riscv-xpack-v0-1-0-released.md`
- name the post like: **µOS++ architecture-riscv-xpack v0.1.0 released**
...
- `npm dist-tag add @micro-os-plus/architecture-riscv-xpack@0.1.0 latest`
- `npm dist-tag ls @@micro-os-plus/architecture-riscv-xpack`
...
- paste the release name like **µOS++ architecture-riscv-xpack v0.1.0 released**
