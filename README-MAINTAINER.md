...
- name the post like: **µOS++ architecture-riscv-xpack v1.1.0 released**
...
- `npm dist-tag add @micro-os-plus/architecture-riscv-xpack@1.1.0 latest`
- `npm dist-tag ls @@micro-os-plus/architecture-riscv-xpack`
...
- paste the release name like **µOS++ architecture-riscv-xpack v1.1.0 released**
