...
- name the post like: **µOS++ architecture-riscv-xpack v3.0.1 released**
...
- `npm dist-tag add @micro-os-plus/architecture-riscv-xpack@3.0.1 latest`
- `npm dist-tag ls @@micro-os-plus/architecture-riscv-xpack`
...
- paste the release name like **µOS++ architecture-riscv-xpack v3.0.1 released**
